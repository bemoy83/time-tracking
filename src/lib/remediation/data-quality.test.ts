...
describe('computeDataQualityProgress', () => {
  ...
  it('includes issue counts by category', () => {
    const issues = makeIssues({
      needsMeasurableOwner: [{ category: 'needs_measurable_owner', taskId: 't1', entryId: 'e1', taskTitle: 'T', description: '', suggestedTargetId: null, suggestedTargetTitle: null, recommendedWorkTypeId: null, suggestionSource: null, personHours: 3 }],
      ambiguousOwner: [
        { category: 'ambiguous_owner', taskId: 't2', entryId: 'e2', taskTitle: 'T2', description: '', suggestedTargetId: 't3', suggestedTargetTitle: 'T3', recommendedWorkTypeId: 'wt-1', suggestionSource: 'engine', personHours: 2 },
        { category: 'ambiguous_owner', taskId: 't4', entryId: 'e4', taskTitle: 'T4', description: '', suggestedTargetId: 't5', suggestedTargetTitle: 'T5', recommendedWorkTypeId: 'wt-2', suggestionSource: 'engine', personHours: 1 },
      ],
      noWorkContext: [],
      totalIssues: 3,
